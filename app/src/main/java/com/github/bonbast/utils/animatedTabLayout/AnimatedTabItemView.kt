package com.github.bonbast.utils.animatedTabLayout
...
class AnimatedTabItemView : LinearLayout {
    ...
    private val iconFromColor: Int = ContextCompat.getColor(context, com.github.bonbast.R.color.atl_icon_from_color)
    private val iconToColor: Int = ContextCompat.getColor(context, com.github.bonbast.R.color.atl_icon_to_color)
