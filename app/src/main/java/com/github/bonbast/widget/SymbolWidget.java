...
package com.github.bonbast.widget;
...
import com.github.bonbast.utils.WidgetHelper;
...
public class SymbolWidget extends AppWidgetProvider {
  ...
  public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
    ...
    for (int appWidgetId : appWidgetIds) {
      ...
      refreshIntent.setAction("com.github.bonbast.widget.REFRESH");
  ...
  public void onReceive(Context context, Intent intent) {
    ...
    if (Objects.equals(intent.getAction(), "com.github.bonbast.widget.REFRESH")) {
